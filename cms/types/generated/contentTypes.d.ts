...
export interface ApiContactContact extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    intent: Schema.Attribute.Enumeration<
      ["I want to Buy", "I want to Rent", "I want to Sell", "Just exploring"]
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiPropertyProperty extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    beds: Schema.Attribute.Enumeration<["BHK_1", "BHK_2", "BHK_3", "BHK_4_Plus"]>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    image: Schema.Attribute.Media<"images" | "files" | "videos" | "audios", true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    locality: Schema.Attribute.Enumeration<
      ["NODE_Kharghar", "NODE_Belapur", "NODE_Nerul", "NODE_Panvel", "NODE_Ulwe", "NODE_Seawoods"]
    >;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::property.property"> &
      Schema.Attribute.Private;
    location: Schema.Attribute.String;
    price: Schema.Attribute.String;
    priceRaw: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    purpose: Schema.Attribute.Enumeration<["Buy", "Rent"]>;
    title: Schema.Attribute.String;
    type: Schema.Attribute.Enumeration<["Apartment", "Villa", "Penthouse", "Plot"]>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
  };
}
